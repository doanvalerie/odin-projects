...
Book.prototype.addToLibrary = function() {
	...
	addTextToCard(this, title, deleteCard, author, pages, description);		
	addStylingToStatus(this, status);
...
defaultBooks = [theHobbit, animalFarm, handmaidsTale];
defaultBooks.forEach(book => book.addToLibrary());
addDialogListeners();
addInputListeners();
